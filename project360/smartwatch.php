...
<body>
  ...
  <div class="container my-5">
    ...
    <nav class="breadcrumb mb-4">
      ...
      <span class="breadcrumb-item active text-secondary fw-bold" aria-current="page">SmartWatches</span>
    </nav>
    ...
    <div class="products-section border rounded p-3">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3" id="productRow">
        <?php
          ...
          // Fetch products where category='SmartWatch' AND best_seller=0
