...
<body>
  ...
  <div class="container my-5">
    ...
    <nav class="breadcrumb mb-4">
      ...
      <span class="breadcrumb-item active text-secondary fw-bold" aria-current="page">Phones</span>
    </nav>
    ...
    <div class="products-section border rounded p-3">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3" id="productRow">
        ...
        <?php
          ...
          // Fetch phone products that are NOT best sellers (best_seller=0)
              ...
              <div class="col">
                ...
                >
                  ...
                  <button 
                     ...
                     image: '<?php echo htmlspecialchars($row['images']); ?>'
                       });"
             >
                     Add To Cart
                  </button>
        ...
        <?php
            ...
            // If no phone products are found, show a message
            echo "<p>No phone products found.</p>";
          endif;
