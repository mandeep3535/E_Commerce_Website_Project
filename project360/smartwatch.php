...
<body>
  ...
  <div class="container my-5">
    ...
    <nav class="breadcrumb mb-4">
      ...
      <span class="breadcrumb-item active text-secondary fw-bold" aria-current="page">SmartWatch</span>
    </nav>
    ...
    <div class="products-section border rounded p-3">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3" id="productRow">
        ...
        <?php
          ...
          // Fetch smartwatch products
          $sql = "SELECT p.*, 
               COALESCE(AVG(r.rating), 0) AS avg_rating, 
               COUNT(r.review_id) AS review_count 
              FROM products p 
              LEFT JOIN reviews r ON p.product_id = r.product_id 
              WHERE p.category = 'SmartWatch' 
        ...
        <?php
            ...
            // If no smartwatch products are found, show a message
            echo "<p>No SmartWatch products found.</p>";
          endif;
